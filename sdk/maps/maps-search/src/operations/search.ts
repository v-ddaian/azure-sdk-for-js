...
import {
  ...
  SearchGetSearchPOICategoryTreePreviewOptionalParams,
  ...
  BatchRequestBody,
  SearchPostSearchFuzzyBatchSyncOptionalParams,
  SearchPostSearchFuzzyBatchSyncResponse,
  SearchPostSearchFuzzyBatchOptionalParams,
  SearchPostSearchFuzzyBatchResponse,
  SearchPostSearchAddressBatchSyncOptionalParams,
  SearchPostSearchAddressBatchSyncResponse,
  SearchPostSearchAddressBatchOptionalParams,
  SearchPostSearchAddressBatchResponse,
  SearchPostSearchAddressReverseBatchSyncOptionalParams,
  SearchPostSearchAddressReverseBatchSyncResponse,
  SearchPostSearchAddressReverseBatchOptionalParams,
...
export class SearchImpl implements Search {
   ...
   * geometry  ID is returned in the dataSources object under "geometry" and "id" in either a Search
  ...
  getSearchPolygon(
    ...
    geometries: string[],
    options?: SearchGetSearchPolygonOptionalParams
  ): Promise<SearchGetSearchPolygonResponse> {
    return this.client.sendOperationRequest(
      { format, geometries, options },
  ...
  ): Promise<SearchGetSearchFuzzyResponse> {
    return this.client.sendOperationRequest(
  ...
  getSearchPOI(
    format: TextFormat,
    query: string,
    options?: SearchGetSearchPOIOptionalParams
  ): Promise<SearchGetSearchPOIResponse> {
    return this.client.sendOperationRequest(
      { format, query, options },
  ...
  getSearchNearby(
    ...
    lat: number,
    lon: number,
    options?: SearchGetSearchNearbyOptionalParams
  ): Promise<SearchGetSearchNearbyResponse> {
    return this.client.sendOperationRequest(
  ...
  ): Promise<SearchGetSearchPOICategoryResponse> {
    return this.client.sendOperationRequest(
      { format, query, options },
   ...
   * @param options The options parameters.
   */
  getSearchPOICategoryTreePreview(
    format: ResponseFormat,
    options?: SearchGetSearchPOICategoryTreePreviewOptionalParams
  ): Promise<SearchGetSearchPOICategoryTreePreviewResponse> {
    return this.client.sendOperationRequest(
      { format, options },
      getSearchPOICategoryTreePreviewOperationSpec
    );
  }
  ...
  ): Promise<SearchGetSearchAddressResponse> {
    return this.client.sendOperationRequest(
      { format, query, options },
  ...
  ): Promise<SearchGetSearchAddressReverseResponse> {
    return this.client.sendOperationRequest(
      { format, query, options },
  ...
  getSearchAddressReverseCrossStreet(
    format: TextFormat,
    query: string,
    options?: SearchGetSearchAddressReverseCrossStreetOptionalParams
  ): Promise<SearchGetSearchAddressReverseCrossStreetResponse> {
    return this.client.sendOperationRequest(
      { format, query, options },
  ...
  ): Promise<SearchGetSearchAddressStructuredResponse> {
    return this.client.sendOperationRequest(
      { format, options },
   ...
   * @param searchInsideGeometryRequestBody This represents the geometry for one or more geographical
   *                                        features (parks, state boundary etc.) to search in and should be a GeoJSON compliant type. Please
  ...
  ): Promise<SearchPostSearchInsideGeometryResponse> {
    return this.client.sendOperationRequest(
      { format, query, searchInsideGeometryRequestBody, options },
   ...
   *                      seconds
   * @param searchAlongRouteRequestBody This represents the route to search along and should be a valid
   *                                    `GeoJSON LineString` type. Please refer to [RFC
   *                                    7946](https://tools.ietf.org/html/rfc7946#section-3.1.4) for details.
   * @param options The options parameters.
   */
  postSearchAlongRoute(
    format: TextFormat,
    query: string,
    maxDetourTime: number,
    searchAlongRouteRequestBody: SearchAlongRouteRequestBody,
    options?: SearchPostSearchAlongRouteOptionalParams
  ): Promise<SearchPostSearchAlongRouteResponse> {
    return this.client.sendOperationRequest(
      { format, query, maxDetourTime, searchAlongRouteRequestBody, options },
   ...
   * API](https://docs.microsoft.com/en-us/rest/api/maps/search/getsearchfuzzy) using just a single API
   ...
   * The string values in the _search fuzzy_ query must be properly escaped (e.g. " character should be
  ...
  postSearchFuzzyBatchSync(
    format: ResponseFormat,
    searchFuzzyBatchRequestBody: BatchRequestBody,
    options?: SearchPostSearchFuzzyBatchSyncOptionalParams
  ): Promise<SearchPostSearchFuzzyBatchSyncResponse> {
    return this.client.sendOperationRequest(
      { format, searchFuzzyBatchRequestBody, options },
      postSearchFuzzyBatchSyncOperationSpec
    );
  }
   ...
   * @param options The options parameters.
   */
  async beginPostSearchFuzzyBatch(
    format: ResponseFormat,
    searchFuzzyBatchRequestBody: BatchRequestBody,
    options?: SearchPostSearchFuzzyBatchOptionalParams
  ): Promise<
    PollerLike<
      PollOperationState<SearchPostSearchFuzzyBatchResponse>,
      SearchPostSearchFuzzyBatchResponse
    >
  > {
    ...
    ): Promise<SearchPostSearchFuzzyBatchResponse> => {
    ...
    return new LROPoller(
      ...
      { format, searchFuzzyBatchRequestBody, options },
      postSearchFuzzyBatchOperationSpec,
      sendOperation,
      "location"
    );
  }
   ...
   * @param options The options parameters.
   */
  async beginPostSearchFuzzyBatchAndWait(
    format: ResponseFormat,
    searchFuzzyBatchRequestBody: BatchRequestBody,
    options?: SearchPostSearchFuzzyBatchOptionalParams
  ): Promise<SearchPostSearchFuzzyBatchResponse> {
    const poller = await this.beginPostSearchFuzzyBatch(
      format,
   ...
   * API](https://docs.microsoft.com/en-us/rest/api/maps/search/getsearchaddress) using just a single API
   * call. You can call Search Address Batch API to run either asynchronously (async) or synchronously
   ...
   * The string values in the _search address_ query must be properly escaped (e.g. " character should be
   * escaped with \\ ) and it should also be properly URL-encoded.
   *
   *
   * The async API allows caller to batch up to **10,000** queries and sync API up to **100** queries,
   ...
   * @param options The options parameters.
   */
  postSearchAddressBatchSync(
    format: ResponseFormat,
    searchAddressBatchRequestBody: BatchRequestBody,
    options?: SearchPostSearchAddressBatchSyncOptionalParams
  ): Promise<SearchPostSearchAddressBatchSyncResponse> {
    return this.client.sendOperationRequest(
      { format, searchAddressBatchRequestBody, options },
      postSearchAddressBatchSyncOperationSpec
    );
  }
   ...
   * @param options The options parameters.
   */
  async beginPostSearchAddressBatch(
    format: ResponseFormat,
    searchAddressBatchRequestBody: BatchRequestBody,
    options?: SearchPostSearchAddressBatchOptionalParams
  ): Promise<
    PollerLike<
      PollOperationState<SearchPostSearchAddressBatchResponse>,
      SearchPostSearchAddressBatchResponse
    >
  > {
    const directSendOperation = async (
      args: coreClient.OperationArguments,
      spec: coreClient.OperationSpec
    ): Promise<SearchPostSearchAddressBatchResponse> => {
      return this.client.sendOperationRequest(args, spec);
    };
    const sendOperation = async (
      args: coreClient.OperationArguments,
    ...
    return new LROPoller(
      { intervalInMs: options?.updateIntervalInMs },
      { format, searchAddressBatchRequestBody, options },
      postSearchAddressBatchOperationSpec,
      sendOperation,
      "location"
    );
  }
   ...
   * @param options The options parameters.
   */
  async beginPostSearchAddressBatchAndWait(
    format: ResponseFormat,
    searchAddressBatchRequestBody: BatchRequestBody,
    options?: SearchPostSearchAddressBatchOptionalParams
  ): Promise<SearchPostSearchAddressBatchResponse> {
    const poller = await this.beginPostSearchAddressBatch(
      format,
   ...
   * API](https://docs.microsoft.com/en-us/rest/api/maps/search/getsearchaddressreverse) using just a
   * single API call. You can call Search Address Reverse Batch API to run either asynchronously (async)
   * or synchronously (sync). The async API allows caller to batch up to **10,000** queries and sync API
   * up to **100** queries.
   * ### Submit Synchronous Batch Request
   * The Synchronous API is recommended for lightweight batch requests. When the service receives a
   * request, it will respond as soon as the batch items are calculated and there will be no possibility
   ...
   * @param options The options parameters.
   */
  postSearchAddressReverseBatchSync(
    format: ResponseFormat,
    searchAddressReverseBatchRequestBody: BatchRequestBody,
    options?: SearchPostSearchAddressReverseBatchSyncOptionalParams
  ): Promise<SearchPostSearchAddressReverseBatchSyncResponse> {
    return this.client.sendOperationRequest(
      { format, searchAddressReverseBatchRequestBody, options },
      postSearchAddressReverseBatchSyncOperationSpec
    );
  }
   ...
   * @param options The options parameters.
   */
  async beginPostSearchAddressReverseBatch(
    format: ResponseFormat,
    searchAddressReverseBatchRequestBody: BatchRequestBody,
    options?: SearchPostSearchAddressReverseBatchOptionalParams
  ): Promise<
    PollerLike<
      PollOperationState<SearchPostSearchAddressReverseBatchResponse>,
      SearchPostSearchAddressReverseBatchResponse
    >
  > {
    const directSendOperation = async (
      args: coreClient.OperationArguments,
      spec: coreClient.OperationSpec
    ): Promise<SearchPostSearchAddressReverseBatchResponse> => {
      return this.client.sendOperationRequest(args, spec);
    };
    const sendOperation = async (
      args: coreClient.OperationArguments,
    ...
    return new LROPoller(
      { intervalInMs: options?.updateIntervalInMs },
      { format, searchAddressReverseBatchRequestBody, options },
      postSearchAddressReverseBatchOperationSpec,
      sendOperation,
      "location"
    );
  }
   ...
   * @param options The options parameters.
   */
  async beginPostSearchAddressReverseBatchAndWait(
    format: ResponseFormat,
    searchAddressReverseBatchRequestBody: BatchRequestBody,
    options?: SearchPostSearchAddressReverseBatchOptionalParams
  ): Promise<SearchPostSearchAddressReverseBatchResponse> {
    const poller = await this.beginPostSearchAddressReverseBatch(
      format,
...
const getSearchPolygonOperationSpec: coreClient.OperationSpec = {
  path: "/search/polygon/{format}",
  httpMethod: "GET",
  responses: {
    200: {
      bodyMapper: Mappers.SearchPolygonResponse
    },
    default: {
...
const getSearchFuzzyOperationSpec: coreClient.OperationSpec = {
  path: "/search/fuzzy/{format}",
  httpMethod: "GET",
  responses: {
    200: {
      bodyMapper: Mappers.SearchCommonResponse
    },
    default: {
      bodyMapper: Mappers.ErrorResponse
    }
  ...
  queryParameters: [
    ...
    Parameters.limit,
    Parameters.ofs,
    Parameters.categorySet,
    Parameters.countrySet,
    Parameters.lat,
    Parameters.lon,
    Parameters.radius,
    Parameters.topLeft,
...
const getSearchPOIOperationSpec: coreClient.OperationSpec = {
...
const getSearchNearbyOperationSpec: coreClient.OperationSpec = {
...
const getSearchPOICategoryOperationSpec: coreClient.OperationSpec = {
...
const getSearchPOICategoryTreePreviewOperationSpec: coreClient.OperationSpec = {
  path: "/search/poi/category/tree/{format}",
  httpMethod: "GET",
  responses: {
    200: {
      bodyMapper: Mappers.SearchPoiCategoryTreeResponse
    },
    default: {
      bodyMapper: Mappers.ErrorResponse
    }
...
const getSearchAddressOperationSpec: coreClient.OperationSpec = {
...
const getSearchAddressReverseOperationSpec: coreClient.OperationSpec = {
  ...
  queryParameters: [
    ...
    Parameters.language,
    Parameters.view,
    Parameters.returnSpeedLimit,
    Parameters.heading,
    Parameters.numberParam,
    Parameters.returnRoadUse,
    Parameters.roadUse,
...
const getSearchAddressReverseCrossStreetOperationSpec: coreClient.OperationSpec = {
...
const getSearchAddressStructuredOperationSpec: coreClient.OperationSpec = {
...
const postSearchInsideGeometryOperationSpec: coreClient.OperationSpec = {
  ...
  requestBody: Parameters.searchInsideGeometryRequestBody,
  queryParameters: [
    Parameters.apiVersion,
    Parameters.query,
    Parameters.limit,
...
const postSearchAlongRouteOperationSpec: coreClient.OperationSpec = {
  ...
  requestBody: Parameters.searchAlongRouteRequestBody,
  queryParameters: [
    Parameters.apiVersion,
    Parameters.query,
    Parameters.categorySet,
...
const postSearchFuzzyBatchSyncOperationSpec: coreClient.OperationSpec = {
  path: "/search/fuzzy/batch/sync/{format}",
  httpMethod: "POST",
  responses: {
    200: {
      bodyMapper: Mappers.SearchFuzzyBatchResponse
    },
    408: {
      bodyMapper: Mappers.ErrorResponse,
      isError: true
...
const postSearchFuzzyBatchOperationSpec: coreClient.OperationSpec = {
...
const postSearchAddressBatchSyncOperationSpec: coreClient.OperationSpec = {
  path: "/search/address/batch/sync/{format}",
  httpMethod: "POST",
  responses: {
    200: {
      bodyMapper: Mappers.SearchAddressBatchResponse
    },
    408: {
      bodyMapper: Mappers.ErrorResponse,
      isError: true
...
const postSearchAddressBatchOperationSpec: coreClient.OperationSpec = {
...
const postSearchAddressReverseBatchSyncOperationSpec: coreClient.OperationSpec = {
  path: "/search/address/reverse/batch/sync/{format}",
  httpMethod: "POST",
  responses: {
    200: {
      bodyMapper: Mappers.SearchAddressReverseBatchResponse
    },
    408: {
      bodyMapper: Mappers.ErrorResponse,
      isError: true
...
const postSearchAddressReverseBatchOperationSpec: coreClient.OperationSpec = {
