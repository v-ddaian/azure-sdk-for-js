...
| ------------------- | --------------------------------------------------------------- |
| [search.ts][search] | Operations useful for finding objects, locations and addresses. |
...
```bash
npx cross-env MAPS_SUBSCRIPTION_KEY="<subscription-key>" node dist/search.js
```

[search]: https://github.com/Azure/azure-sdk-for-js/blob/master/sdk/maps/maps-search/samples/v1/typescript/src/search.ts
