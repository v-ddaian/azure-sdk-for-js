...
import { Geography, TrafficClientOptionalParams } from "./models";
...
export class TrafficClientContext extends coreClient.ServiceClient {
  ...
  /**
   * Initializes a new instance of the TrafficClientContext class.
  ...
  constructor(
    ...
    const defaults: TrafficClientOptionalParams = {
