...
export class RenderV2Impl implements RenderV2 {
  ...
  getMapTilePreview(
    ...
    return this.client.sendOperationRequest(
      { tilesetId, zoom, xTileIndex, yTileIndex, options },
      getMapTilePreviewOperationSpec
    );
  }
}
...
const getMapTilePreviewOperationSpec: coreClient.OperationSpec = {
  path: "/map/tile",
  httpMethod: "GET",
  responses: {
    200: {
      ...
      headersMapper: Mappers.RenderV2GetMapTilePreviewHeaders
    },
    default: {
